function createPopUpsManager(action, element) {
    ...
    switch (action) {
        case "addList":
            ...
            break;
        case "editList":
            createPopUpEditList(element);
            break;
        case "removeList":
            createPopUpRemoveList(element);
            break;
        case "editToDo":
            createPopUpEditToDo(element);
            break;
        case "removeToDo":
            createPopUpRemoveToDo(element);
            break;
        case "sendMessage":
            createPopUpSendMessage(element);
            break;
    }
...
function createListsRender() {
    ...
    for (let position in todos.reverse()) {
        ...
        buttonEdit.setAttribute(
            "onclick",
            'createPopUpsManager("editList", this)'
        );
        ...
        buttonRemove.setAttribute(
            "onclick",
            'createPopUpsManager("removeList", this)'
        );
...
function createToDosRender(list, type) {
    for (let item of list.reverse()) {
        ...
        buttonEdit.setAttribute(
            "onclick",
            'createPopUpsManager("editToDo", this)'
        );
        ...
        buttonRemove.setAttribute(
            "onclick",
            'createPopUpsManager("removeToDo", this)'
        );
        ...
        type === "done" && itemCheck.setAttribute("checked", "checked");
